...
function twentyseventeen_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-home',
		'description'   => __( 'Add widgets here to appear in your sidebar for home.', 'twentyseventeen' ),
		'before_widget' => '<div class="column"><section id="%1$s" class="card widget %2$s"><div class="card-content">',
		'after_widget'  => '</div></section></div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function twentyseventeen_scripts() {
	...
	if(get_page_template_slug() == 'templates/assets.php'){
	  wp_enqueue_style( 'assets', get_stylesheet_directory_uri().'/assets/css/tpl/assets.css', array(), null );
