<?php $comment_args = array(
	...
	'fields' => apply_filters( 'comment_form_default_fields', array(
		...
		'author' => '<div class="comment-form-author field">' . '<label for="author" class="label">' . __( 'Nom*' ) .
		            '</label><input 
id="author" class="input" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' .
		            $aria_req . ' /></div>',

		'email' => '<div class="comment-form-email field"><label for="email" class="label">' . __( 'Email*' ) . '</label><input 
id="email" class="email input" name="email" type="text" value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' />' . '</div>',
	...
	'comment_field' => '<div class="field">' .
	                   ...
	                   '<label for="comment" class="label" class="label">' . __( 'Message:' ) . '</label><textarea id="comment" 
